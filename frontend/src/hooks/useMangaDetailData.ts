...
export function useMangaDetailData(id: string | undefined) {
  return useItemDetailData<BookDetail>("manga", id, {
    includeGroups: true,
    groupType: "volume",
    mapPropertyItems,
  });
...
export type UseMangaDetailDataResult = ReturnType<typeof useMangaDetailData>;

...
export function useNovelDetailData(id: string | undefined) {
  return useItemDetailData<BookDetail>("novel", id, {
    includeGroups: true,
    groupType: "chapter",
    mapPropertyItems,
  });
...
export type UseNovelDetailDataResult = ReturnType<typeof useNovelDetailData>;
